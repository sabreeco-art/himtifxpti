                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                $mengambil = "SELECT * FROM course ORDER BY id DESC";
                                                $hasil = mysqli_query($koneksi, $mengambil);
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 15px">
                                                        <a href="edit-course.php?id=<?php echo $data['id'] ?>"
                                                            class=""><i class="fas fa-edit"></i></a>
                                                    </td>
                                                    <td><a href="delete-course.php?id=<?php echo $data['id'] ?>"><i
