...
<html lang="en">
    ...
    <head>
        ...
        <title>Ubah Pengaturan Contact Page - LearnGo</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Settings Contact Page</h1>
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                    class="fas fa-download fa-sm text-white-50"></i></a>
                        </div>

                        <!-- Content Row -->
                        <form action="proses-edit-contactpage.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control form-control-sm mb-3" name="n_phone"
                                        value="<?= $data['n_phone'] ?>">
                                    <span>Email Support</span>
                                    <input type="text" class="form-control form-control-sm mb-3" name="email_support"
                                        value="<?= $data['email_support'] ?>">
                                    <span>Email General</span>
                                    <input type="text" class="form-control form-control-sm mb-3" name="email_general"
                                        value="<?= $data['email_general'] ?>">
                                </div>
                            </div>
                            <h4 class="text-center mt-4">Social Media</h4>
                            <div class="row">
                                <!-- Area Chart -->
                                <div class="col-md-6">
                                    <span>Instagram</span>
                                    <input type="text" class="form-control form-control-sm mb-3" name="instagram"
                                        value="<?= $data['instagram'] ?>">
                                    <span>Twitter</span>
                                    <input type="text" class="form-control form-control-sm mb-3" name="twitter"
                                        value="<?= $data['twitter'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <span>Facebook</span>
                                    <input type="text" class="form-control form-control-sm mb-3" name="facebook"
                                        value="<?= $data['facebook'] ?>">
                                    <span>Linkedin</span>
                                    <input type="text" class="form-control form-control-sm mb-3" name="linkedin"
                                        value="<?= $data['linkedin'] ?>">
                                </div>
                                <div class="m-auto">
                                    <input type="submit" value="Simpan" class="btn btn-secondary mt-3 mb-4">
                                </div>
                            </div>
