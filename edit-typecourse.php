...
$mengambil = "SELECT * FROM typecourse WHERE id='$id'";
$result = mysqli_query($koneksi, $mengambil);
$typecourse = mysqli_fetch_assoc($result);
...
<html lang="en">
    ...
    <head>
        ...
        <title>Edit Type Of Course - LearnGo</title>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseCourse" class="collapse show" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="type-course.php">Type Of Course</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Edit Type Of Course</h1>
                        </div>

                        <!-- Content Row -->
                        <form method="post" action="edit-typecourse-proses.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-9">
                                    <input type="hidden" value="<?= $typecourse['id'] ?>" name="id">
                                    <input class="w-100 form form-control" type="text"
                                        value="<?= $typecourse['title'] ?>" name="title">
                                    <div class="mt-5">
                                        <textarea name="description" id="contents"
                                            rows="5"><?= $typecourse['description'] ?></textarea>
                                        <script>
