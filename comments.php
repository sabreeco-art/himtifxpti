...
<html lang="en">
    ...
    <head>
        ...
        <title>All Comments - LearnGo</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-7">
                                    <div class="d-flex justify-content-end" style="margin-right: 5px">
                                        <?php
                                        $mengambil = "SELECT COUNT(*) AS total FROM commentuser";
                                    ...
                                    <div class="card shadow mb-4">
                                        <div>
                                            <table class="table table-hover">
                                                ...
                                                $mengambil = "SELECT * FROM commentuser ORDER BY id DESC";
                                                $hasil = mysqli_query($koneksi, $mengambil);
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="delete-comments.php?id=<?php echo $data['id'] ?>"><i
                                    ...
                                    <div class="d-flex justify-content-end"
                                        style="margin-top: -1.2rem; margin-right: 5px">
                                        <?php
                                            $mengambil = "SELECT COUNT(*) AS total FROM commentuser";
                                            $hasil = mysqli_query($koneksi, $mengambil);
                                            $data = mysqli_fetch_assoc($hasil);
