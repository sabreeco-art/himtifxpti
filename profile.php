                        ...
                        <form method="post" action="proses-edit-profile.php" enctype="multipart/form-data" class="mb-3">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <img id="img" class="img-thumbnail" alt="..."
                                        src="data:image/jpeg;base64,<?php echo base64_encode($_SESSION['image']); ?>" />
                                    <input type="text" class="form-control form-control-sm" value="<?php if (isset($_SESSION['nama_file'])) {
                                            $nama_file = $_SESSION['nama_file']; } else { $nama_file = ""; } ?>"
                                        readonly>
                                </div>
                                <div class="col-md-4">
                                    <div>
                                        <label for="name">Name</label>
                                        <input type="text" class="form form-control" name="firstname"
                                    ...
                                    <div class="d-flex">
                                        <input type="submit" value="Save Changes" class="btn btn-primary d-flex"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <textarea type="text" class="form form-control" rows="6" name="about"><?php if (isset($_SESSION['about'])) {
                                            $about = $_SESSION['about']; } else { $about = ""; } ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </form>
