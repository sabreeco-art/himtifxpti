...
if (isset($_GET['id'])) {
	...
	if (!count($data)) {
		echo "<script>alert('Data tidak ditemukan pada database');window.location='categories.php';</script>";
	}
} else {
	echo "<script>alert('Masukkan data id.');window.location='categories.php';</script>";
}
...
<html lang="en">
    ...
    <head>
        ...
        <title>Edit Categories - LearnGo</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-9">
                                <form method="post" action="proses-edit-categories.php">
                                    <div>
