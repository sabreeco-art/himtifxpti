...
<html lang="en">
    ...
    <head>
        ...
        <title>All Message - LearnGo</title>
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseFeedback" class="collapse show" aria-labelledby="headingPages"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="comments.php">Comments</a>
                            <a class="collapse-item active" href="message.php">Message</a>
                        </div>
                    </div>
                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="d-flex justify-content-end" style="margin-right: 5px">
                                    <?php
                                        $mengambil = "SELECT COUNT(*) AS total FROM massage_user";
                                    ...
                                    <div>
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                $mengambil = "SELECT * FROM massage_user ORDER BY id DESC";
                                                $hasil = mysqli_query($koneksi, $mengambil);
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td style="font-size: 15px">
                                                        <a href="edit-post.php?id=<?php echo $data['id'] ?>" class=""><i
                                                                class="fas fa-edit"></i></a>
                                                    </td> -->
                                                    <td><a href="delete-message.php?id=<?php echo $data['id'] ?>"><i
