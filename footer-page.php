...
<html lang="en">
    ...
    <head>
        ...
        <title>Ubah Pengaturan Footer - LearnGo</title>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseSettings" class="collapse show" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            ?>
                            <a class="collapse-item active" href="footer-page.php">Footer</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Settings Footer</h1>
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                    class="fas fa-download fa-sm text-white-50"></i></a>
                        </div>

                        <!-- Content Row -->
                        <form action="proses-edit-footerpage.php" method="post" enctype="multipart/form-data"
                            onsubmit="return validateForm()">
                            <input type="hidden" name="id" value="<?= $data['id'] ?>">
                            <div class="row">
                                <!-- Area Chart -->
                                <div class="col-md-12">
                                    <p class="mb-1">Logo Web</p>
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <label for="file" class="btn btn-secondary">Change Image</label>
                                            <input id="file" type="file" class="d-none" name="image">
                                        </div>
                                    </div>
                                    <p class="mb-1 mt-4">Description</p>
                                    <input type="text" name="description" value="<?= $data['description'] ?>"
                                        class="form-control">

                                    <div class="row mb-1 mt-4">
                                        <div class="col-md-6">
                                            <span class="m-auto">Nama Web</span>
                                            <input type="text" name="nama_web" value="<?= $data['nama_web'] ?>"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-6">
                                            <span class="m-auto">Desaigned By</span>
                                            <input type="text" name="desain_by" value="<?= $data['desain_by'] ?>"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-1 mt-4 mb-4">
                                        <div class="col-md-3">
                                            <span class="m-auto">Link Instagram</span>
                                            <input type="text" name="link_ig" value="<?= $data['link_ig'] ?>"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <span class="m-auto">Link Facebook</span>
                                            <input type="text" name="link_fb" value="<?= $data['link_fb'] ?>"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <span class="m-auto">Link Twitter</span>
                                            <input type="text" name="link_twt" value="<?= $data['link_twt'] ?>"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <span class="m-auto">Link Linkedin</span>
                                            <input type="text" name="link_lk" value="<?= $data['link_lk'] ?>"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
