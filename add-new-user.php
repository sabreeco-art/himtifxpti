...
<html lang="en">
    ...
    <head>
        ...
        <title>Add New User - LearnGo</title>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUsers" class="collapse show" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="add-new-user.php">Add New</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Content Row -->
                        <form method="post" action="add-new-user-proses.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="m-0">First Name</p>
                                        <input class="form-control form-control-sm w-75" type="text" name="firstname"
                                            required>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        <p class="m-0">Last Name</p>
                                        <input class="form-control form-control-sm w-75" type="text" name="lastname"
                                            required>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        ...
                                        <input class="form-control form-control-sm w-75" type="password" name="password"
                                            required>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        <p class="m-0">Confirm Password</p>
                                        <input class="form-control form-control-sm w-75" type="password"
                                            name="cpassword" required>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        <p class="m-0">Role</p>
                                        <select class="form-control form-control-sm w-75" name="role" required>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        ...
                                        <input id="file-input" type="file" class="form-control form-control-sm w-75"
                                            name="image" value="<?php echo $_SESSION['nama_file'] ?>">
                                    </div>
                                    <input type="submit" value="Add New User" class="btn btn-primary mt-5">
                                </div>
                                <div class="col-md-5">
                                </div>
                            </div>
