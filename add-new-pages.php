...
<html lang="en">
    ...
    <head>
        ...
        <title>Add New Pages - LearnGo</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Add New Pages</h1>
                        </div>

                        <!-- Content Row -->
                        <form method="post" action="add-new-pages-proses.php">
                            <div class="row">
                                <div class="col-md-9">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="card mt-5">
                                        ...
                                        <div class="card-body p-0 px-2 py-2">
                                            <input type="text" name="src" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    <div class="card mt-3">
                                        <div class="card-header py-0 pt-2">
                                        ...
                                        <div class="card-body p-0 px-2 py-2">
                                            <input type="text" name="src_db" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    <div class="card mt-3">
                                        <div class="card-header py-0 pt-2">
