...
if (isset($_GET['id'])) {
	...
	if (!count($data)) {
		echo "<script>alert('Data tidak ditemukan pada database');window.location='all-course.php';</script>";
	}
} else {
	echo "<script>alert('Masukkan data id.');window.location='all-course.php';</script>";
}
?>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Edit Course - LearnGo</title>
            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion " id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseCourse" class="collapse show" aria-labelledby="headingPages"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item active" href="all-course.php">All Course</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Content Row -->
                        <form method="post" action="edit-course-proses.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-9">
