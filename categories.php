...
<html lang="en">
    ...
    <head>
        ...
        <title>Categories - LearnGo</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <form method="post" action="add-new-category.php">
                                    <div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <textarea name="description" class="form form-control" rows="3"></textarea>
                                        <span style="font-size: 13px">The description is not prominent by default;
                                            however,
                                            some themes may show it.</span>
                                    </div>
                                    <input type="submit" value="Add New Category" class="btn btn-primary mt-3">
                                </form>
                            </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 15px">
                                                    <a href="edit-categories.php?id=<?php echo $data['id'] ?>"
                                                        class=""><i class="fas fa-edit"></i></a>
                                                </td>
                                                <td><a href="delete-categories.php?id=<?php echo $data['id'] ?>"><i
