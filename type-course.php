...
<html lang="en">
    ...
    <head>
        ...
        <title>All Course - LearnGo</title>
    ...
    <body id="page-top">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Type Of Course</h1>
                            <a href="add-new-type-course.php"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="d-flex justify-content-end" style="margin-right: 5px">
                                    <?php
                                        $mengambil = "SELECT COUNT(*) AS total FROM typecourse";
                                ...
                                <div class="card shadow mb-4">
                                    <div>
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th><input type="radio" name="pilih" value="semua"
                                                            onclick="pilihSemua()"></th>
                                            ...
                                            <tbody>
                                                ...
                                                $mengambil = "SELECT * FROM typecourse ORDER BY id DESC";
                                                $hasil = mysqli_query($koneksi, $mengambil);
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php //echo $no; ?>
                                                        <input type="radio" name="pilih" value="<?= $data['title'] ?>">
                                                    </td>
                                                    ...
                                                    <td style="font-size: 15px">
                                                        <a href="edit-typecourse.php?id=<?php echo $data['id'] ?>"
                                                            class=""><i class="fas fa-edit"></i></a>
                                                    </td>
                                                    <td><a href="delete-typecourse.php?id=<?php echo $data['id'] ?>"><i
        ...
        <script>
        function pilihSemua() {
            var radios = document.getElementsByName('pilih');
